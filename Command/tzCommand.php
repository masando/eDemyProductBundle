...
class tzCommand extends ContainerAwareCommand
{
    private $client;
    private $domain;
    private $categoria;
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->categorias($crawler, '#block-menu-menu-categoria ul.menu li a');
    }
    ...
    protected function writeCsv($products, $file = 'products.csv') {
        $fp = fopen('/var/www/__.es/web/d/' . $this->sluggify($file) . '.csv', 'w');
        fputcsv($fp, array(
            'Handle', 
            'Title',
            'Body (HTML)',
